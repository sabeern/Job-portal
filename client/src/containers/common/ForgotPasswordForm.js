    ...
    return (
        <MDBCol sm='6'>
              ...
              <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
                    ...
                    {otpStatus ?  (<><MDBInput wrapperClass='mb-4 mx-5 w-100' type='number' name="otp" label='Enter Otp' id='formControlLg'  value={otp} onChange={(e)=>setOtp(e.target.value)} size="lg"/>
                ...
                : <MDBBtn className="mb-4 px-5 mx-5 w-100" color='primary' size='lg' onClick={handleOtp}>Next</MDBBtn> 
                    ...
                    <p className='ms-5'>Already Register?  <Link to="/signin">
                            Signin here</Link>
                    </p>
              </div>
            </MDBCol>
    ...
    return(
        <MDBCol sm='6'>
              ...
              <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
                    ...
                    <p className='ms-5'>No need to continue?  <Link to="/signin">
                            Cancel</Link>
                    </p>
              </div>
            </MDBCol>
